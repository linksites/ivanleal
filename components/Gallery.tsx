    ...
    <section id="galeria" className="gallery sectionShell">
      <div className="sectionTitle fadeInUp">
        <div>
          ...
          <h2>Conquistas reais, bastidores e presenca de competidor.</h2>
        </div>
        <p>
          Um recorte visual para comunicar autoridade sem artificio: medalhas,
          podium, preparacao e momentos que sustentam a marca Ivan Leal JJ.
        </p>
      </div>
